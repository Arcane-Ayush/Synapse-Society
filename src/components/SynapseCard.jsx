...
function getCardBackground(card) {
    if (card.level === 5) {
        return `
            radial-gradient(ellipse at 20% 20%, rgba(124,58,237,0.9) 0%, transparent 60%),
            radial-gradient(ellipse at 80% 80%, rgba(217,70,239,0.8) 0%, transparent 60%),
...
function FoilEffect({ card, active, mousePos }) {
    const colors = card.foilColors || ["#A855F7", "#D946EF"];
    if (!active) return null;
            ...
            {Array.from({ length: 12 }).map((_, i) => (
                <div
                    ...
                    style={{
                        left: `${10 + (i * 7) % 80}%`,
                        top: `${15 + (i * 11) % 70}%`,
                        background: i % 3 === 0 ? '#F0ABFC' : i % 3 === 1 ? '#A855F7' : '#E879F9',
                        boxShadow: `0 0 6px ${i % 3 === 0 ? '#F0ABFC' : '#A855F7'}`,
...
export function SynapseCard({ card, size = "md", showBack = false, className = "" }) {
    ...
    const borderGlow = isMythic
        ? 'rgba(168,85,247,0.8), rgba(217,70,239,0.6), rgba(168,85,247,0.8)'
        : isLegendary
            ? 'rgba(239,68,68,0.7), rgba(245,158,11,0.5)'
            : `${card.colors?.glow || 'rgba(124,58,237,0.5)'}`;
            ...
            >
                ...
                <div
                    ...
                    style={{
                        ...
                        boxShadow: hovered
                            ? `0 30px 80px rgba(0,0,0,0.8), 0 0 40px ${card.colors?.glow || 'rgba(124,58,237,0.5)'}`
                ...
                >
                    ...
                    <div
                        ...
                        style={{
                            ...
                            background: isMythic
                                ...
                                : `linear-gradient(135deg, ${card.colors?.primary || '#7C3AED'}88, ${card.colors?.secondary || '#A855F7'}44, ${card.colors?.primary || '#7C3AED'}88)`,
                    ...
                    <div className="relative z-10 flex flex-col h-full p-4">
                        ...
                        <div className="mb-2">
                            {card.level !== null && card.level !== undefined && (
                                <div className="flex items-center gap-2 mb-1">
                                    <span
                                        ...
                                        style={{ color: card.colors?.secondary || '#A855F7', opacity: 0.6 }}
                                    >
                            ...
                            <h3
                                ...
                                style={{
                                    ...
                                    color: '#fff',
                                    textShadow: hovered ? `0 0 12px ${card.colors?.glow || 'rgba(168,85,247,0.6)'}` : 'none',
                                }}
                            >
                                {card.name}
                            </h3>
                        ...
                        <p
                            ...
                            style={{ color: 'rgba(196,181,253,0.6)', fontFamily: 'Inter' }}
                        >
                            {card.description}
                        </p>
                        ...
                        {card.type === 'membership' && card.xpRequired !== undefined && (
                            <div className="mb-3">
                                <div className="flex justify-between text-[9px] font-mono mb-1" style={{ color: 'rgba(196,181,253,0.4)' }}>
                                ...
                                <div className="h-1 rounded-full" style={{ background: 'rgba(124,58,237,0.15)' }}>
                                    <div
                                        ...
                                        style={{
                                            ...
                                            background: `linear-gradient(90deg, ${card.colors?.primary || '#7C3AED'}, ${card.colors?.secondary || '#A855F7'})`,
                                            boxShadow: `0 0 6px ${card.colors?.glow || 'rgba(124,58,237,0.5)'}`,
                                        }}
                                    />
                                </div>
                            </div>
                        ...
                        {card.type === 'event' && card.worth && (
                            <div
                                ...
                                style={{ background: `${card.colors?.primary || '#7C3AED'}15`, border: `1px solid ${card.colors?.primary || '#7C3AED'}25` }}
                            >
                                <span style={{ color: 'rgba(196,181,253,0.5)' }}>TOKEN VALUE</span>
                                <span style={{ color: card.colors?.secondary || '#A855F7', fontWeight: 700 }}>
                                    {card.worth} ◈
                                </span>
                            </div>
                        )}
                        ...
                        <div
                            ...
                            style={{ borderTop: `1px solid ${card.colors?.primary || '#7C3AED'}20` }}
                        >
                            {/* QR placeholder */}
                            <div
                                ...
                                style={{
                                    ...
                                    border: `1px solid ${card.colors?.primary || '#7C3AED'}30`,
                                }}
                            >
                            ...
                            <div className="text-center">
                                {isMythic && (
                                    <span className="text-[9px] font-mono" style={{ color: '#A855F7', opacity: 0.6 }}>
                                        MYTHIC TIER
                                    </span>
                                )}
                            </div>
                            ...
                            <div className="text-right">
                                {card.maxSupply && (
                                    <div className="text-[9px] font-mono" style={{ color: 'rgba(196,181,253,0.3)' }}>
                                        /{card.maxSupply}
                                    </div>
                                )}
                                <div className="text-[9px] font-mono" style={{ color: 'rgba(196,181,253,0.25)' }}>
                                    SYNAPSE©
                                </div>
                            </div>
                        </div>
                    ...
                    {!card.unlocked && (
                        ...
                        >
                            <div
                                className="mb-2"
                                style={{ filter: 'drop-shadow(0 0 8px rgba(124,58,237,0.5))', color: 'rgba(124,58,237,0.8)' }}
                            >
                            ...
                            <p
                                ...
                                style={{ color: 'rgba(168,85,247,0.6)', letterSpacing: '0.1em' }}
                            >
                                {card.type === 'membership'
                                    ? `EARN ${card.xpRequired} XP`
                                    : 'SEASON 1'}
                            </p>
                            <p className="text-[9px] font-mono mt-1" style={{ color: 'rgba(168,85,247,0.3)' }}>
                                TO UNLOCK
                            </p>
                        </div>
                    )}
